	...
	<div class="card" style="width: 18rem;">
		...
		<div class="card-body">
			...
			{#if word.answer}
				...
				<p class="card-text">Верно! Ты молодец :)</p>
				<p class="card-text green">+2XP за верный ответ</p>
			{:else}
				<img
				...
				<p class="card-text">Пока неверно, продолжай тренировки и в следующий раз обязательно получится.</p>
			{/if}
		</div>
		<div class="d-flex">
